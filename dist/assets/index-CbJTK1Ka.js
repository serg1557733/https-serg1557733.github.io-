      ...
      e: for (var W = 0, X = x.length, er = X >>> 1; W < er; ) {
        ...
        if (0 > l(wl, z))
          gn < X && 0 > l(nr, wl)
            ? ((x[W] = nr), (x[gn] = z), (W = gn))
            : ((x[W] = wl), (x[yn] = z), (W = yn));
        else if (gn < X && 0 > l(nr, z)) (x[W] = nr), (x[gn] = z), (W = gn);
        else break e;
      }
    }
    return P;
    ...
    (e.unstable_scheduleCallback = function (x, P, z) {
      ...
      return (
        ...
        z > W
          ...
          : ((x.sortIndex = X), n(s, x), g || w || ((g = !0), yl(E))),
        x
      );
    }),
...
function Fc(e, n, t, r, l, o, i, u, s) {
  (Ct = !1), (Mr = null), Ic.apply(Dc, arguments);
}
...
function bo(e, n, t, r) {
  if (Dr) {
    var l = co(e, n, t, r);
    if (l === null) Il(e, n, r, Fr, t), Ki(e, r);
...
var Fr = null;
function co(e, n, t, r) {
  if (((Fr = null), (e = Xo(r)), (e = kn(e)), e !== null))
...
var ut = {
  ...
  zl = we(of),
  uf = V({}, ut, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  sf = we(uf),
  af = V({}, ut, {
...
var vf = V({}, Zt, {
  ...
  Sf = we(wf),
  kf = V({}, ut, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Ef = we(kf),
  xf = V({}, rl, {
    deltaX: function (e) {
...
function As(e) {
  if (e.propertyName === "value" && ll(Ut)) {
    var n = [];
    Us(n, Ut, e, Xo(e)), ws(Tf, n);
  }
}
function Mf(e, n, t) {
  e === "focusin"
    ? (ru(), (Nt = n), (Ut = t), Nt.attachEvent("onpropertychange", As))
    : e === "focusout" && ru();
}
function jf(e) {
...
var je = typeof Object.is == "function" ? Object.is : Df;
function $t(e, n) {
  if (je(e, n)) return !0;
  ...
  for (r = 0; r < t.length; r++) {
    var l = t[r];
    if (!ql.call(n, l) || !je(e[l], n[l])) return !1;
  }
  return !0;
}
function lu(e) {
      ...
      e: {
        ...
        if (
          ...
          if (
            ...
            n: {
              for (S = w, f = g, a = 0, d = S; d; d = jn(d)) a++;
...
var st = Math.random().toString(36).slice(2),
  ...
  go = "__reactEvents$" + st,
  Kf = "__reactListeners$" + st,
  Yf = "__reactHandles$" + st;
function kn(e) {
  var n = e[De];
  if (n) return n;
...
function vn() {
  if (!Fl && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), xs(Go, vn), l);
    } finally {
      (j = n), (Fl = !1);
    }
  }
...
function ed(e, n, t) {
  ...
  if (xa(e)) Ca(n, l);
    ...
    (t = la(e, n, l, r)),
      t !== null && ((l = ie()), Me(t, e, r, l), _a(t, n, r));
  }
}
function xa(e) {
  var n = e.alternate;
...
function Lu(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    ...
    u !== m || p !== g || fe.current || Je
      ? (typeof w == "function" && (xo(n, t, w, r), (g = n.memoizedState)),
        (c = Je || Eu(n, t, c, r, p, g, s) || !1)
          ? (h ||
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[De], delete n[Bt], delete n[go], delete n[Kf], delete n[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Me(e, n, t, r) {
  if (50 < Rt) throw ((Rt = 0), (Do = null), Error(y(185)));
  Gt(e, t, r),
    (!(R & 2) || e !== Z) &&
      (e === Z && (!(R & 2) && (fl |= t), Y === 4 && en(e, b)),
      pe(e, r),
...
function pe(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && qi(t), n === 1))
      e.tag === 0 ? Xf(Uu.bind(null, e)) : Js(Uu.bind(null, e)),
        Qf(function () {
          !(R & 6) && vn();
        }),
        (t = null);
...
function Ha(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = br(e, r);
    ...
    R |= 2;
    var o = Qa();
    (Z !== e || b !== n) && ((Ae = null), (ot = Q() + 500), Cn(e, n));
    do
      try {
        vd();
        break;
...
function Pi() {
  (Y === 0 || Y === 3 || Y === 2) && (Y = 4),
    Z === null || (!(Ln & 268435455) && !(fl & 268435455)) || en(Z, b);
}
function br(e, n) {
  var t = R;
  R |= 2;
  ...
  while (!0);
  if ((ai(), (R = t), (Gr.current = r), q !== null)) throw Error(y(261));
  return (Z = null), (b = 0), Y;
}
function hd() {
  for (; q !== null; ) qa(q);
...
function Sn(e, n, t) {
  var r = j,
    l = xe.transition;
  try {
    (xe.transition = null), (j = 1), yd(e, n, t, r);
  } finally {
    (xe.transition = l), (j = r);
  }
  return null;
...
function gd(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    Z === e &&
      (b & t) === t &&
      (Y === 4 || (Y === 3 && (b & 130023424) === b && 500 > Q() - Ci)
        ? Cn(e, 0)
        : (xi |= t)),
    pe(e, n);
}
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Zo(n, t | 1), pe(n, Q()), !(R & 6) && ((ot = Q() + 500), vn()));
      }
      break;
    case 13:
      Tn(function () {
...
ys = _i;
gs = Tn;
var Pd = { usingClientEntryPoint: !1, Events: [Jt, An, il, hs, vs, _i] },
  gt = {
...
const Td = "./assets/3-B3RtUVwy.png",
  On = [
    {
  ...
  Rd = "./assets/4e-Y1tACsrj.png",
  Md = "./assets/rt-B0-HMYMU.webp",
  jd = ({ onLogin: e }) => {
    const [n, t] = Fe.useState(0),
      [r, l] = Fe.useState(localStorage.getItem("balance") ?? 0),
      [o, i] = Fe.useState(!1),
      [u, s] = Fe.useState(""),
      c = (g) => {
        i(!0),
          ...
          g === On[n].answer &&
            l((S) => {
              const O = +S + 100;
              return localStorage.setItem("balance", O.toString()), O;
            });
      },
      h = () => {
        i(!1),
    ...
    return (
      ...
      M.jsxs("div", {
        ...
        children: [
          M.jsxs("div", {
            className: "flex justify-around content-center w-3/4 p-3",
            children: [
              M.jsx("h1", {
                className: "m-3 p-3 bg-blue-600 rounded-3xl",
                children: "Кто хочет стать миллионером?",
              }),
              M.jsx("button", {
          ...
          M.jsxs("div", {
            className: "flex-col self-end m-4",
            children: [
              M.jsxs("div", {
                className: `w-48 ${w ? "animate-bounce" : ""}`,
                children: [
                  w && M.jsx("img", { src: Md, alt: "euro" }),
                  M.jsx("img", { src: Rd, alt: "euro" }),
                ],
              }),
              M.jsxs("h2", {
                className:
                  "p-4 border rounded-3xl border-l-amber-300 border-solid font-bold bg-red-600",
          ...
          o &&
            M.jsxs("div", {
              children: [
                M.jsxs("p", {
                  className:
                    "p-3 font-extrabold rounded-2xl w-full bg-green-700",
                  children: ["Правильный ответ: ", On[n].answer],
                }),
                M.jsx("button", {
                  onClick: h,
          ...
          M.jsx("div", {
            ...
            children: M.jsxs("div", {
              children: [
                M.jsxs("h2", {
                  className: "mb-2 p-6 rounded-3xl font-bold bg-blue-600",
                  children: ["Вопрос ", n + 1, ": ", m],
                }),
                M.jsx("div", {
                  className: "m-0",
                  children: p.map((g, S) =>
  ...
  Od = ({ onLogin: e }) => {
    const [n, t] = Fe.useState(""),
      ...
      o = () => {
        n === "mykhailo" && r === "admin"
          ? (localStorage.setItem("auth", "true"), e("true"))
    ...
    return M.jsxs("div", {
      ...
      children: [
        M.jsxs("div", {
          className: "m-2 w-3/4",
          children: [
            M.jsx("h1", { className: "m-2", children: "Login" }),
            M.jsx("h2", { children: "Введите свое имя и пароль" }),
          ],
        }),
        M.jsxs("div", {
          className: "flex flex-col m-3 w-1/4",
          children: [
            M.jsx("input", {
              className: "m-2",
              type: "text",
  ...
  Id = () => {
    const [e, n] = Fe.useState(localStorage.getItem("auth")),
      t = (r) => {
        localStorage.setItem("auth", r), n(r);
      };
    return M.jsx(M.Fragment, {
      children: e ? M.jsx(jd, { onLogin: t }) : M.jsx(Od, { onLogin: t }),
    });
  };
nc(document.getElementById("root")).render(
  M.jsx(Fe.StrictMode, { children: M.jsx(Id, {}) })
);
