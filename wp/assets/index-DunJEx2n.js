  ...
  function E(x, N) {
    ...
    try {
      ...
      if (m !== null) var er = !0;
        ...
        var yn = t(c);
        yn !== null && gl(v, yn.startTime - N), (er = !1);
      }
      return er;
    } finally {
      (m = null), (p = z), (g = !1);
...
function bo(e, n, t, r) {
  if (Fr) {
    var l = co(e, n, t, r);
    if (l === null) Il(e, n, r, Dr, t), Ki(e, r);
...
var it = {
  ...
  zl = we(of),
  uf = V({}, it, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  sf = we(uf),
  af = V({}, it, {
...
var vf = V({}, Zt, {
  ...
  Sf = we(wf),
  kf = V({}, it, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Ef = we(kf),
  xf = V({}, rl, {
    deltaX: function (e) {
...
function ru() {
  Pt && (Pt.detachEvent("onpropertychange", As), (Ut = Pt = null));
}
function As(e) {
...
function Mf(e, n, t) {
  e === "focusin"
    ? (ru(), (Pt = n), (Ut = t), Pt.attachEvent("onpropertychange", As))
    : e === "focusout" && ru();
}
function Of(e) {
  ...
  if (!e[fr]) {
    (e[fr] = !0),
      rs.forEach(function (t) {
        t !== "selectionchange" && (Vf.has(t) || jl(t, !1, e), jl(t, !0, e));
      });
      ...
      P &&
        (Is &&
          ...
          (Fn || P !== "onCompositionStart"
            ? P === "onCompositionEnd" && Fn && (_ = js())
            : ((nn = h),
              (ei = "value" in nn ? nn.value : nn.textContent),
              (Fn = !0))),
        (C = Ur(c, P)),
        0 < C.length &&
          ((P = new Zi(P, e, null, t, h)),
...
function ta(e) {
  ...
  function p(f, a, d, v) {
    ...
    if (typeof d == "object" && d !== null) {
      ...
      if (St(d) || ct(d)) return E !== null ? null : h(f, a, d, v, null);
      mr(f, d);
    }
    return null;
  }
  function g(f, a, d, v, E) {
    ...
    if (typeof v == "object" && v !== null) {
      ...
      if (St(v) || ct(v)) return (f = f.get(d) || null), h(a, f, v, E, null);
      mr(a, v);
    }
    return null;
  }
  ...
  function S(f, a, d, v) {
    ...
    if (T.done) return t(f, _), U && wn(f, P), E;
    if (_ === null) {
  ...
  nd = {
    ...
    useImperativeHandle: function (e, n, t) {
      return (
        ...
        Pr(4194308, 4, ya.bind(null, n, e), t)
      );
    },
...
function id(e, n, t, r, l, o, i) {
  ...
  if (((u = (i & e.childLanes) !== 0), ce || u)) {
    ...
    return Ni(), (r = Bl(Error(y(421)))), hr(e, n, i, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
...
function ud(e, n, t) {
  switch (n.tag) {
    ...
    case 10:
      ...
      j(Wr, r._currentValue), (r._currentValue = l);
      break;
    case 13:
      ...
      return n.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((n.child.flags |= 8192),
            n.mode & 1 &&
              (e === null || $.current & 1 ? Y === 0 && (Y = 3) : Ni())),
          n.updateQueue !== null && (n.flags |= 4),
          te(n),
          null);
    case 4:
      return (
        tt(), To(e, n), e === null && At(n.stateNode.containerInfo), te(n), null
      );
    case 10:
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[Bt], delete n[go], delete n[Kf], delete n[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Va(e, n) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      Ne(n, e), je(e), r & 512 && t !== null && Wn(t, t.return);
      break;
    case 5:
      if (
        (Ne(n, e),
    ...
    case 3:
      if (
        (Ne(n, e), je(e), r & 4 && t !== null && t.memoizedState.isDehydrated)
      )
        try {
          Dt(n.containerInfo);
        } catch (S) {
...
function Ha(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = br(e, r);
    ...
    R |= 2;
    var o = Qa();
    (Z !== e || b !== n) && ((Ae = null), (lt = Q() + 500), Cn(e, n));
    do
      try {
        vd();
        break;
  ...
  if (n !== 0) {
    if (
      (n === 2 && ((l = so(e)), l !== 0 && ((r = l), (n = Do(e, l)))), n === 1)
    )
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Zo(n, t | 1), pe(n, Q()), !(R & 6) && ((lt = Q() + 500), vn()));
      }
      break;
    case 13:
      Tn(function () {
...
ys = _i;
gs = Tn;
var Nd = { usingClientEntryPoint: !1, Events: [Jt, $n, il, hs, vs, _i] },
  yt = {
...
const Td = "./3-B3RtUVwy.png",
  ...
  Rd = "./4e-Y1tACsrj.png",
  Md = ({ onLogin: e }) => {
    const [n, t] = De.useState(0),
      [r, l] = De.useState(localStorage.getItem("balance") ?? 0),
      [o, i] = De.useState(!1),
      [u, s] = De.useState(""),
      c = (g) => {
        i(!0),
          ...
          g === gt[n].answer &&
            l((w) => {
              const S = +w + 100;
              return localStorage.setItem("balance", S.toString()), S;
            });
      },
      h = () => {
        i(!1),
        ...
        M.jsxs("div", {
          ...
          children: [
            M.jsx("div", {
              ...
              children: M.jsx("img", { src: Rd, alt: "euro" }),
            }),
            M.jsxs("h2", {
              className:
              ...
              M.jsxs("div", {
                children: [
                  M.jsxs("p", {
                    ...
                    children: ["Правильный ответ: ", gt[n].answer],
                  }),
                  M.jsx("button", {
                    onClick: h,
                    style: {
      ...
      children: [
        ...
        M.jsxs("div", {
          ...
          children: [
            ...
            M.jsx("button", { onClick: o, children: "Login" }),
          ],
        }),
      ],
    });
  ...
  jd = () => {
    const [e, n] = De.useState(localStorage.getItem("auth")),
      t = (r) => {
        localStorage.setItem("auth", r), n(r);
      };
    return M.jsx(M.Fragment, {
      children: e ? M.jsx(Md, { onLogin: t }) : M.jsx(Od, { onLogin: t }),
    });
  };
nc(document.getElementById("root")).render(
  M.jsx(De.StrictMode, { children: M.jsx(jd, {}) })
);
